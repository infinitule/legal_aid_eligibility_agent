...
**Domain:** Access to justice and support navigation  
...
Many citizens do not know whether they may be eligible for free legal aid or which documents are needed. Build an agent that asks eligibility questions, maps to rules from provided documents, and creates a document checklist.
...
Build a working solution for **Legal Aid Eligibility and Document Preparation Agent** that takes relevant input data, processes it through a clear workflow, and produces an actionable output for real users or decision-makers.
...
RAG over legal aid docs, eligibility questionnaire, document checklist, legal-advice guardrail.
...
**Dataset / Reference Name:** NALSA reference material

**Link:** https://nalsa.gov.in/

**How to Use It:**
Use official legal services authority pages or provided legal-aid notes as reference documents.
...
```text
legal_aid_eligibility_and_document_preparation_agent/
│
├── data/
